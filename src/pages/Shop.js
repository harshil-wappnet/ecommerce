        ...
        <div className='container grid grid-cols-4 gap-6 pb-16 items-start'>
            ...
            <div className='col-span-3 '>
                ...
                <div className='grid grid-cols-3 gap-6'>
                        ...
                        <div className='pt-4 pb-3 px-4 flex flex-col flex-grow'> {/* Use flex-grow to fill remaining space */}
                            <Link to='/'>
                                <h4 className='uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition overflow-hidden'>
                                    {/* {title.length > 30 ? `${title.substring(0, 30)}...` : title} */}Floral Print Fit & Flare Dress with Waist Tie-Up
                                </h4>
                            </Link>
                    ...
                    <div className='bg-white shadow rounded overflow-hidden group flex flex-col'>
                        <div className='relative flex-shrink-0'>
                            <img src={vneckdress} alt='' className='w-full' />
                            <div className='absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition'>
                                <Link to='/' className='text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition'>
                                    <FaSearch />
                                </Link>
                        ...
                        <div className='pt-4 pb-3 px-4 flex flex-col flex-grow'> {/* Use flex-grow to fill remaining space */}
                            <Link to='/'>
                                <h4 className='uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition overflow-hidden'>
                                    {/* {title.length > 30 ? `${title.substring(0, 30)}...` : title} */}Solid Fit and Flare Dress
                                </h4>
                            </Link>
                            <div className='flex justify-between items-start mb-1'> {/* Adjusted alignment to start */}
                                <div>
                                    <p className='text-xl text-primary font-semibold '>$55.00</p>
                                    <p className='text-sm text-gray-400 line-through'>$75.00</p>
                                </div>
                                <div className='flex gap-1 text-sm text-yellow-400'>
                                    <span><FaStar /></span>
                                    <span><FaStar /></span>
                    ...
                    <div className='bg-white shadow rounded overflow-hidden group flex flex-col'>
                        <div className='relative flex-shrink-0'>
                            <img src={dressback} alt='' className='w-full' />
                            <div className='absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition'>
                                <Link to='/' className='text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition'>
                                    <FaSearch />
                                </Link>
                        ...
                        <div className='pt-4 pb-3 px-4 flex flex-col flex-grow'> {/* Use flex-grow to fill remaining space */}
                            <Link to='/'>
                                <h4 className='uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition overflow-hidden'>
                                    {/* {title.length > 30 ? `${title.substring(0, 30)}...` : title} */}Micro-Print A-line Dress
                                </h4>
                            </Link>
                            <div className='flex justify-between items-start mb-1'> {/* Adjusted alignment to start */}
                                <div>
                                    <p className='text-xl text-primary font-semibold '>$15.00</p>
                    ...
                    <div className='bg-white shadow rounded overflow-hidden group flex flex-col'>
                        <div className='relative flex-shrink-0'>
                            <img src={vneckdress1} alt='' className='w-full' />
                            <div className='absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100 transition'>
                                <Link to='/' className='text-white text-lg w-9 h-8 rounded-full bg-primary flex items-center justify-center hover:bg-gray-800 transition'>
                                    <FaSearch />
                                </Link>
                        ...
                        <div className='pt-4 pb-3 px-4 flex flex-col flex-grow'> {/* Use flex-grow to fill remaining space */}
                            <Link to='/'>
                                <h4 className='uppercase font-medium text-xl mb-2 text-gray-800 hover:text-primary transition overflow-hidden'>
                                    {/* {title.length > 30 ? `${title.substring(0, 30)}...` : title} */}V-Neck Fit & Flare Dress
                                </h4>
                            </Link>
                            <div className='flex justify-between items-start mb-1'> {/* Adjusted alignment to start */}
                                <div>
                                    <p className='text-xl text-primary font-semibold '>$25.00</p>
                                    <p className='text-sm text-gray-400 line-through'>$35.00</p>
                                </div>
                                <div className='flex gap-1 text-sm text-yellow-400'>
                                    <span><FaStar /></span>
                                    <span><FaStar /></span>
